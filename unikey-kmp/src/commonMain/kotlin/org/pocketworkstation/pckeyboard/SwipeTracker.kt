 ...
 * Platform-independent version - call addPoint() directly with coordinates and timestamp.
 */
class SwipeTracker {
    ...
    /**
     * Call when touch begins to clear the buffer.
     */
    fun onTouchDown() {
        buffer.clear()
    }
    ...
    /**
     * Add a touch point with coordinates and timestamp.
