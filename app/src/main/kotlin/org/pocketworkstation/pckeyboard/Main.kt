...
class Main : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setup4.setOnClickListener {
            startActivityForResult(Intent(this, InputLanguageSelection::class.java), 0)
        }

        val setup3 = findViewById<Button>(R.id.main_setup_btn_get_dicts)
        setup3.setOnClickListener {
            val intent = Intent(Intent.ACTION_VIEW, Uri.parse(MARKET_URI))
            try {
        ...
        setup5.setOnClickListener {
            startActivityForResult(Intent(this, LatinIMESettings::class.java), 0)
        }
    }
