...
abstract class Dictionary {
     ...
     * @param composer the key sequence to match
     * @param previousWord the word before the current one
     ...
     */
    abstract fun isValidWord(word: CharSequence): Boolean
     ...
     */
    protected fun same(word: CharArray, length: Int, typedWord: CharSequence): Boolean {
    ...
    companion object {
         ...
         */
        const val INCLUDE_TYPED_WORD_IF_VALID = false

        /**
         * The weight to give to a word if its length is the same as the number of typed characters.
         */
        const val FULL_WORD_FREQ_MULTIPLIER = 2
    }
}
