...
class PrefScreenView : PreferenceActivity(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    override fun onCreate(icicle: Bundle?) {
        ...
        mRenderModePreference = findPreference(LatinIME.PREF_RENDER_MODE) as ListPreference?
    }
