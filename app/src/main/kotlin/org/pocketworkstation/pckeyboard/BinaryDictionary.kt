...
class BinaryDictionary : Dictionary {
    ...
    private external fun isValidWordNative(nativeData: Long, word: CharArray, wordLength: Int): Boolean
    ...
    override fun getBigrams(
        ...
        for (j in 0 until count) {
            ...
            var len = 0
            while (mOutputChars_bigrams[start + len] != 0.toChar()) {
                len++
            }
            if (len > 0) {
                callback.addWord(
